...
For each release (e.g. 1.109 -> 1.110), edit ONLY the CONFIG section below:
  ...
  2. The BULLETS dict: the what's-new bullets in all 10 languages
...
It reads the previous version's files and produces:
  ...
  - updates src/translations.py                   (10 whats_new_info blocks)
...
BULLETS = {
 'en': [
  ...
  ('Russian, Finnish and Swedish', 'The app is now available in Russian, Finnish and Swedish. Choose the language in Settings, under Change Language: every button, menu, dialog and help text is translated, and each language has its flag in the list.'),
 ],
 'fr': [
  ...
  ('Russe, finnois et suédois', "L'application est désormais disponible en russe, en finnois et en suédois. Choisissez la langue dans Paramètres, sous Changer de langue : chaque bouton, menu, boîte de dialogue et texte d'aide est traduit, et chaque langue a son drapeau dans la liste."),
 ],
 'de': [
  ...
  ('Russisch, Finnisch und Schwedisch', 'Die App ist jetzt auch auf Russisch, Finnisch und Schwedisch verfügbar. Wählen Sie die Sprache in den Einstellungen unter Sprache ändern: Jede Schaltfläche, jedes Menü, jeder Dialog und jeder Hilfetext ist übersetzt, und jede Sprache hat ihre Flagge in der Liste.'),
 ],
 'it': [
  ...
  ('Russo, finlandese e svedese', "L'app è ora disponibile in russo, finlandese e svedese. Scegli la lingua in Impostazioni, sotto Cambia lingua: ogni pulsante, menu, finestra e testo di aiuto è tradotto, e ogni lingua ha la sua bandiera nell'elenco."),
 ],
 'es': [
  ...
  ('Ruso, finés y sueco', 'La aplicación ya está disponible en ruso, finés y sueco. Elige el idioma en Configuración, bajo Cambiar idioma: todos los botones, menús, diálogos y textos de ayuda están traducidos, y cada idioma tiene su bandera en la lista.'),
 ],
 'pt': [
  ...
  ('Russo, finlandês e sueco', 'A aplicação está agora disponível em russo, finlandês e sueco. Escolha o idioma em Configurações, em Mudar idioma: todos os botões, menus, janelas e textos de ajuda estão traduzidos, e cada idioma tem a sua bandeira na lista.'),
 ],
 'he': [
  ...
  ('רוסית, פינית ושוודית', 'האפליקציה זמינה כעת גם ברוסית, בפינית ובשוודית. בחרו את השפה בהגדרות, תחת שינוי שפה: כל כפתור, תפריט, חלון וטקסט עזרה מתורגמים, ולכל שפה יש דגל ברשימה.'),
 ],
 'ru': [
  ...
  ('Русский, финский и шведский', 'приложение теперь доступно на русском, финском и шведском языках. Выберите язык в настройках, в разделе «Сменить язык»: переведены все кнопки, меню, диалоги и справочные тексты, а у каждого языка в списке есть свой флаг.'),
 ],
 'fi': [
  ...
  ('Venäjä, suomi ja ruotsi', 'Sovellus on nyt saatavilla venäjäksi, suomeksi ja ruotsiksi. Valitse kieli asetuksista kohdasta Vaihda kieli: jokainen painike, valikko, ikkuna ja ohjeteksti on käännetty, ja jokaisella kielellä on oma lippunsa luettelossa.'),
 ],
 'sv': [
  ...
  ('Ryska, finska och svenska', 'Programmet finns nu på ryska, finska och svenska. Välj språk i Inställningar under Byt språk: varje knapp, meny, dialog och hjälptext är översatt, och varje språk har sin flagga i listan.'),
 ],
}
...
# ----------------------------------------------------------------------------
# 3) Inno Setup .iss: defines + the 10 WelcomeLabel2 lines
...
# ----------------------------------------------------------------------------
# 4) translations.py: the 10 whats_new_info blocks (in-app What's New dialog)
# ----------------------------------------------------------------------------
TR = {

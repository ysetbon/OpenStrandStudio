...
# Use underscores instead of dots in the output filename (e.g. 1.108 -> 1_108) so
# the version dot is never mistaken for a file extension. VERSION itself stays
# dotted for the installer title and pkg metadata.
...
<body>
    ...
    <hr>
    <!-- Japanese -->
    <h2 dir="ltr">OpenStrandStudio x へようこそ</h2>
    ...
    <hr>
    <!-- Chinese -->
    <h2 dir="ltr">欢迎使用 OpenStrandStudio x</h2>

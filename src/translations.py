...
''',
        ...
        # Button tooltips
        'reset_tooltip': 'Reset: Keep only current state as first state',
        'refresh_tooltip': 'Refresh: Reload layers',
        'center_tooltip': 'Center: Pan to center all strands in canvas',
        'hide_mode_tooltip': 'Hide Mode: Click to enable layer selection,\nthen right-click for batch hide/show operations',
        'zoom_in_tooltip': 'Zoom In',
        'zoom_out_tooltip': 'Zoom Out',
        'pan_tooltip': 'Pan: Click and drag to move the canvas',
...
''',
        ...
        # Button tooltips
        'reset_tooltip': 'Réinitialiser : Garder uniquement l\'état actuel comme premier état',
        'refresh_tooltip': 'Actualiser : Recharger les calques',
        'center_tooltip': 'Centrer : Déplacer pour centrer tous les fils dans le canevas',
        'hide_mode_tooltip': 'Mode Masquer : Cliquez pour activer la sélection de calques,\npuis clic droit pour les opérations de masquage/affichage par lot',
        'zoom_in_tooltip': 'Zoom avant',
        'zoom_out_tooltip': 'Zoom arrière',
        'pan_tooltip': 'Panoramique : Cliquez et faites glisser pour déplacer le canevas',
...
''',
        ...
        # Button tooltips
        'reset_tooltip': 'Ripristina: Mantieni solo lo stato corrente come primo stato',
        'refresh_tooltip': 'Aggiorna: Ricarica i livelli',
        'center_tooltip': 'Centra: Sposta per centrare tutti i fili nel canvas',
        'hide_mode_tooltip': 'Modalità Nascondi: Clicca per abilitare la selezione dei livelli,\npoi click destro per operazioni di nascondi/mostra in batch',
        'zoom_in_tooltip': 'Zoom avanti',
        'zoom_out_tooltip': 'Zoom indietro',
        'pan_tooltip': 'Panoramica: Clicca e trascina per muovere il canvas',
...
''',
        ...
        # Button tooltips
        'reset_tooltip': 'Restablecer: Mantener solo el estado actual como primer estado',
        'refresh_tooltip': 'Actualizar: Recargar capas',
        'center_tooltip': 'Centrar: Desplazar para centrar todos los cordones en el lienzo',
        'hide_mode_tooltip': 'Modo Ocultar: Haga clic para habilitar la selección de capas,\nluego clic derecho para operaciones de ocultar/mostrar por lotes',
        'zoom_in_tooltip': 'Acercar',
        'zoom_out_tooltip': 'Alejar',
        'pan_tooltip': 'Panorámica: Haga clic y arrastre para mover el lienzo',
...
''',
        ...
        # Button tooltips
        'reset_tooltip': 'Redefinir: Manter apenas o estado atual como primeiro estado',
        'refresh_tooltip': 'Atualizar: Recarregar camadas',
        'center_tooltip': 'Centralizar: Mover para centralizar todas as mechas na tela',
        'hide_mode_tooltip': 'Modo Ocultar: Clique para ativar a seleção de camadas,\ndepois clique direito para operações de ocultar/mostrar em lote',
        'zoom_in_tooltip': 'Aumentar zoom',
        'zoom_out_tooltip': 'Diminuir zoom',
        'pan_tooltip': 'Panorâmica: Clique e arraste para mover a tela',
...
''',
        ...
        # Button tooltips
        'reset_tooltip': 'איפוס: שמור רק את המצב הנוכחי\nכמצב ראשון',
        'refresh_tooltip': 'רענון: טען מחדש שכבות',
        'center_tooltip': 'מרכז: הזז למרכז כל החוטים בקנבס',
        'hide_mode_tooltip': 'מצב הסתרה: לחץ להפעלת בחירת שכבות,\nואז לחץ ימני לפעולות הסתרה/הצגה קבוצתיות',
        'zoom_in_tooltip': 'הגדל',
        'zoom_out_tooltip': 'הקטן',
        'pan_tooltip': 'גרירה: לחץ וגרור להזזת הקנבס',

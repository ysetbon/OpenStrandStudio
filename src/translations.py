...
''',
        ...
        <h2>What's New in Version 1.111</h2>
            ...
            <li style="font-size:14px;"><b>Russian, Finnish and Swedish:</b> The app is now available in Russian, Finnish and Swedish. Choose the language in Settings, under Change Language: every button, menu, dialog and help text is translated, and each language has its flag in the list.</li>
...
''',
        ...
        <h2>Nouveautés de la version 1.111</h2>
            ...
            <li style="font-size:14px;"><b>Russe, finnois et suédois:</b> L'application est désormais disponible en russe, en finnois et en suédois. Choisissez la langue dans Paramètres, sous Changer de langue : chaque bouton, menu, boîte de dialogue et texte d'aide est traduit, et chaque langue a son drapeau dans la liste.</li>
...
''',
        ...
        <h2>Novità della versione 1.111</h2>
            ...
            <li style="font-size:14px;"><b>Russo, finlandese e svedese:</b> L'app è ora disponibile in russo, finlandese e svedese. Scegli la lingua in Impostazioni, sotto Cambia lingua: ogni pulsante, menu, finestra e testo di aiuto è tradotto, e ogni lingua ha la sua bandiera nell'elenco.</li>
...
''',
        ...
        <h2>Novedades de la versión 1.111</h2>
            ...
            <li style="font-size:14px;"><b>Ruso, finés y sueco:</b> La aplicación ya está disponible en ruso, finés y sueco. Elige el idioma en Configuración, bajo Cambiar idioma: todos los botones, menús, diálogos y textos de ayuda están traducidos, y cada idioma tiene su bandera en la lista.</li>
...
''',
        ...
        <h2>Novidades da versão 1.111</h2>
            ...
            <li style="font-size:14px;"><b>Russo, finlandês e sueco:</b> A aplicação está agora disponível em russo, finlandês e sueco. Escolha o idioma em Configurações, em Mudar idioma: todos os botões, menus, janelas e textos de ajuda estão traduzidos, e cada idioma tem a sua bandeira na lista.</li>
...
''',
        ...
        <h2>מה חדש בגרסה 1.111</h2>
            ...
            <li style="font-size:14px;"><b>רוסית, פינית ושוודית:</b> האפליקציה זמינה כעת גם ברוסית, בפינית ובשוודית. בחרו את השפה בהגדרות, תחת שינוי שפה: כל כפתור, תפריט, חלון וטקסט עזרה מתורגמים, ולכל שפה יש דגל ברשימה.</li>
...
Совет: щёлкните правой кнопкой по значкам панели слоёв, чтобы увидеть их описание!''',
        ...
        <h2>Что нового в версии 1.111</h2>
            ...
            <li style="font-size:14px;"><b>Русский, финский и шведский:</b> приложение теперь доступно на русском, финском и шведском языках. Выберите язык в настройках, в разделе «Сменить язык»: переведены все кнопки, меню, диалоги и справочные тексты, а у каждого языка в списке есть свой флаг.</li>
...
Vinkki: napsauta tasopaneelin kuvakkeita hiiren oikealla painikkeella nähdäksesi niiden selitykset!''',
        ...
        <h2>Mitä uutta versiossa 1.111</h2>
            ...
            <li style="font-size:14px;"><b>Venäjä, suomi ja ruotsi:</b> Sovellus on nyt saatavilla venäjäksi, suomeksi ja ruotsiksi. Valitse kieli asetuksista kohdasta Vaihda kieli: jokainen painike, valikko, ikkuna ja ohjeteksti on käännetty, ja jokaisella kielellä on oma lippunsa luettelossa.</li>
...
Tips: högerklicka på ikonerna i lagerpanelen för att se deras förklaringar!''',
        ...
        <h2>Vad är nytt i version 1.111</h2>
            ...
            <li style="font-size:14px;"><b>Ryska, finska och svenska:</b> Programmet finns nu på ryska, finska och svenska. Välj språk i Inställningar under Byt språk: varje knapp, meny, dialog och hjälptext är översatt, och varje språk har sin flagga i listan.</li>

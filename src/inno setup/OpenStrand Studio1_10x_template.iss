...
; Inno Setup ships Swedish.isl from 6.4 on. On older versions run
; "install_swedish_isl.bat" (next to this script) once to copy it into the compiler's Languages folder.

...
''',
        ...
        'tutorial': 'Tutorial',
        'button_explanations': 'Schaltflächen-Leitfaden',
        'history': 'Verlauf',
        ...
        'draw_names': 'Namen zeichnen',
        'lock_layers': 'Ebenen sperren',
        'add_new_strand': 'Neuer Strang',
        'delete_strand': 'Strang löschen',
        ...
        'hide_mode_tooltip': 'Versteckmodus:\nKlicken, um Ebenenauswahl\nzu aktivieren, dann Rechtsklick\nfür Sammel-\nEin-/Ausblendung',

...
''',
        ...
        # Button tooltips
        'reset_tooltip': 'Reset:\nKeep only current state as first state',
        'refresh_tooltip': 'Refresh:\nReload layers',
        'center_tooltip': 'Center:\nPan to center all strands in canvas',
        'hide_mode_tooltip': 'Hide Mode:\nClick to enable layer selection,\nthen right-click for\nbatch hide/show operations',
        ...
        'close_the_knot': 'Close the Knot (beta)',
...
''',
        ...
        'close_the_knot': 'Fermer le Nœud (bêta)',
        ...
        # Button tooltips
        'reset_tooltip': 'Réinitialiser :\nGarder uniquement l\'état actuel\ncomme premier état',
        'refresh_tooltip': 'Actualiser :\nRecharger les calques',
        'center_tooltip': 'Centrer :\nDéplacer pour centrer tous les fils\ndans le canevas',
        'hide_mode_tooltip': 'Mode Masquer :\nCliquez pour activer la sélection\nde calques, puis clic droit pour\nles opérations de masquage/affichage\npar lot',
...
''',
        ...
        'close_the_knot': 'Chiudi il Nodo (beta)',
        ...
        # Button tooltips
        'reset_tooltip': 'Ripristina:\nMantieni solo lo stato corrente\ncome primo stato',
        'refresh_tooltip': 'Aggiorna:\nRicarica i livelli',
        'center_tooltip': 'Centra:\nSposta per centrare tutti i fili\nnel canvas',
        'hide_mode_tooltip': 'Modalità Nascondi:\nClicca per abilitare la selezione\ndei livelli,\npoi click destro per\noperazioni di nascondi/mostra in batch',
...
''',
        ...
        'close_the_knot': 'Cerrar el Nudo (beta)',
        ...
        # Button tooltips
        'reset_tooltip': 'Restablecer:\nMantener solo el estado actual\ncomo primer estado',
        'refresh_tooltip': 'Actualizar:\nRecargar capas',
        'center_tooltip': 'Centrar:\nDesplazar para centrar todos\nlos cordones en el lienzo',
        'hide_mode_tooltip': 'Modo Ocultar:\nHaga clic para habilitar la selección\nde capas,\nluego clic derecho para\noperaciones de ocultar/mostrar por lotes',
...
''',
        ...
        'close_the_knot': 'Fechar o Nó (beta)',
        ...
        # Button tooltips
        'reset_tooltip': 'Redefinir:\nManter apenas o estado atual\ncomo primeiro estado',
        'refresh_tooltip': 'Atualizar:\nRecarregar camadas',
        'center_tooltip': 'Centralizar:\nMover para centralizar todas\nas mechas na tela',
        'hide_mode_tooltip': 'Modo Ocultar:\nClique para ativar a seleção\nde camadas,\ndepois clique direito para\noperações de ocultar/mostrar em lote',
...
''',
        ...
        'close_the_knot': 'סגור את הקשר (בטא)',

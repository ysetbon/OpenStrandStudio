...
2. Use the provided Inno Setup script:
   ...
   - Open `OpenStrand Studio1_109.iss` in Inno Setup Compiler
   - Click "Compile" to create the installer

   > The `.iss` for each release is generated by `scripts/make_release_files.py`
   > (see `src/RELEASE_HOWTO.md`) — don't write it by hand.

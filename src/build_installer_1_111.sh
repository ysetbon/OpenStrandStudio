...
<body>
    ...
    <ul>
        ...
        <li><b>Russian, Finnish, Swedish, Japanese and Chinese:</b> The app is now available in Russian, Finnish, Swedish, Japanese and Chinese. Choose the language in Settings, under Change Language: every button, menu, dialog and help text is translated, and each language has its flag in the list.</li>
    </ul>
    <hr>
    <!-- German -->
    ...
    <ul>
        ...
        <li><b>Russe, finnois, suédois, japonais et chinois:</b> L'application est désormais disponible en russe, en finnois, en suédois, en japonais et en chinois. Choisissez la langue dans Paramètres, sous Changer de langue : chaque bouton, menu, boîte de dialogue et texte d'aide est traduit, et chaque langue a son drapeau dans la liste.</li>
    </ul>
    <hr>
    <!-- Italian -->
    ...
    <ul>
        ...
        <li><b>Russo, finlandese, svedese, giapponese e cinese:</b> L'app è ora disponibile in russo, finlandese, svedese, giapponese e cinese. Scegli la lingua in Impostazioni, sotto Cambia lingua: ogni pulsante, menu, finestra e testo di aiuto è tradotto, e ogni lingua ha la sua bandiera nell'elenco.</li>
    </ul>
    <hr>
    <!-- Spanish -->
    ...
    <ul>
        ...
        <li><b>Ruso, finés, sueco, japonés y chino:</b> La aplicación ya está disponible en ruso, finés, sueco, japonés y chino. Elige el idioma en Configuración, bajo Cambiar idioma: todos los botones, menús, diálogos y textos de ayuda están traducidos, y cada idioma tiene su bandera en la lista.</li>
    </ul>
    <hr>
    <!-- Portuguese -->
    ...
    <ul>
        ...
        <li><b>Russo, finlandês, sueco, japonês e chinês:</b> A aplicação está agora disponível em russo, finlandês, sueco, japonês e chinês. Escolha o idioma em Configurações, em Mudar idioma: todos os botões, menus, janelas e textos de ajuda estão traduzidos, e cada idioma tem a sua bandeira na lista.</li>
    </ul>
    <hr>
    <!-- Hebrew -->
    <div dir="rtl">
    ...
    <ul>
        ...
        <li><b>&#x05E8;&#x05D5;&#x05E1;&#x05D9;&#x05EA;, &#x05E4;&#x05D9;&#x05E0;&#x05D9;&#x05EA;, &#x05E9;&#x05D5;&#x05D5;&#x05D3;&#x05D9;&#x05EA;, &#x05D9;&#x05E4;&#x05E0;&#x05D9;&#x05EA; &#x05D5;&#x05E1;&#x05D9;&#x05E0;&#x05D9;&#x05EA;:</b> &#x05D4;&#x05D0;&#x05E4;&#x05DC;&#x05D9;&#x05E7;&#x05E6;&#x05D9;&#x05D4; &#x05D6;&#x05DE;&#x05D9;&#x05E0;&#x05D4; &#x05DB;&#x05E2;&#x05EA; &#x05D2;&#x05DD; &#x05D1;&#x05E8;&#x05D5;&#x05E1;&#x05D9;&#x05EA;, &#x05D1;&#x05E4;&#x05D9;&#x05E0;&#x05D9;&#x05EA;, &#x05D1;&#x05E9;&#x05D5;&#x05D5;&#x05D3;&#x05D9;&#x05EA;, &#x05D1;&#x05D9;&#x05E4;&#x05E0;&#x05D9;&#x05EA; &#x05D5;&#x05D1;&#x05E1;&#x05D9;&#x05E0;&#x05D9;&#x05EA;. &#x05D1;&#x05D7;&#x05E8;&#x05D5; &#x05D0;&#x05EA; &#x05D4;&#x05E9;&#x05E4;&#x05D4; &#x05D1;&#x05D4;&#x05D2;&#x05D3;&#x05E8;&#x05D5;&#x05EA;, &#x05EA;&#x05D7;&#x05EA; &#x05E9;&#x05D9;&#x05E0;&#x05D5;&#x05D9; &#x05E9;&#x05E4;&#x05D4;: &#x05DB;&#x05DC; &#x05DB;&#x05E4;&#x05EA;&#x05D5;&#x05E8;, &#x05EA;&#x05E4;&#x05E8;&#x05D9;&#x05D8;, &#x05D7;&#x05DC;&#x05D5;&#x05DF; &#x05D5;&#x05D8;&#x05E7;&#x05E1;&#x05D8; &#x05E2;&#x05D6;&#x05E8;&#x05D4; &#x05DE;&#x05EA;&#x05D5;&#x05E8;&#x05D2;&#x05DE;&#x05D9;&#x05DD;, &#x05D5;&#x05DC;&#x05DB;&#x05DC; &#x05E9;&#x05E4;&#x05D4; &#x05D9;&#x05E9; &#x05D3;&#x05D2;&#x05DC; &#x05D1;&#x05E8;&#x05E9;&#x05D9;&#x05DE;&#x05D4;.</li>
    </ul>
    </div>
    <hr>
    <!-- Russian -->
    <h2 dir="ltr">Добро пожаловать в OpenStrandStudio 1.111</h2>
    <p>Эта программа установит OpenStrandStudio на ваш компьютер. Вы пройдёте все необходимые шаги установки.</p>
    <p>Что нового в версии 1.111:</p>
    <ul>
        ...
        <li><b>Правильный размер на масштабированных экранах:</b> на экранах с высоким разрешением и включённым масштабированием кнопки и текст выглядели слишком мелко. Теперь приложение учитывает масштаб экрана. Надписи на панели инструментов больше не обрезаются, а при узком окне панель переносится на две строки. Панель слоёв можно сузить сильнее, чем раньше. Логотип OpenStrand Studio теперь показывается в каждом окне и на панели задач.</li>
        <li><b>Диалоги помещаются на маленьких экранах:</b> диалог настроек теперь можно уменьшить, поэтому кнопки «Применить» и «ОК» всегда остаются на экране. То же касается редактора теней, редактора теней группы, создания сетки масок, изменения углов прядей, изменения ширины и видеоплеера. Диалог никогда не открывается больше экрана и сохраняет заданный вами размер.</li>
        <li><b>Более плавное перетаскивание:</b> холст остаётся чётким во время перетаскивания даже на масштабированных экранах или при включённом суперсэмплинге. В режиме перемещения при перетаскивании точки показывается сжатая ладонь. В режиме обзора теперь можно панорамировать и левой кнопкой мыши. Подсказка кнопки «Обновить» теперь говорит, что она делает: перезагружает слои и сбрасывает вид.</li>
        <li><b>Русский, финский, шведский, японский и китайский:</b> приложение теперь доступно на русском, финском, шведском, японском и китайском языках. Выберите язык в настройках, в разделе «Сменить язык»: переведены все кнопки, меню, диалоги и справочные тексты, а у каждого языка в списке есть свой флаг.</li>
    </ul>
    <hr>
    <!-- Finnish -->
    <h2 dir="ltr">Tervetuloa OpenStrandStudio 1.111 -ohjelmaan</h2>
    <p>Tämä asentaa OpenStrandStudion tietokoneellesi. Sinut opastetaan asennuksen vaiheiden läpi.</p>
    <p>Mitä uutta versiossa 1.111:</p>
    <ul>
    ...
    <ul>
        ...
        <li><b>Mjukare dragning:</b> arbetsytan förblir skarp medan du drar, även på skalade skärmar eller med supersampling påslaget. Flyttläget visar en knuten hand när en punkt dras. Vyläget kan nu panorera även med vänster musknapp. Uppdatera-knappens verktygstips säger nu vad den gör: laddar om lagren och återställer vyn.</li>
        <li><b>Ryska, finska, svenska, japanska och kinesiska:</b> Programmet finns nu på ryska, finska, svenska, japanska och kinesiska. Välj språk i Inställningar under Byt språk: varje knapp, meny, dialog och hjälptext är översatt, och varje språk har sin flagga i listan.</li>
    </ul>
    <hr>
    <!-- Japanese -->
    <h2 dir="ltr">OpenStrandStudio 1.111 へようこそ</h2>
    <p>このプログラムは OpenStrandStudio をお使いのコンピューターにインストールします。インストールに必要な手順を順に案内します。</p>
    <p>バージョン 1.111 の新機能:</p>
    <ul>
        <li><b>端のスタイル設定:</b> 自由な端を持つレイヤーを右クリックし、「結び目を閉じる」のすぐ下にある「端のスタイル設定」を選びます。ダイアログでストランドの終わり方を選べます: 直線、斜め、丸み、尖り、切り欠き、凹み。傾きと深さの設定、端の延長や切り詰め、独自の太さと色を持つサイドラインの追加もできます。プレビューはキャンバス上にリアルタイムで表示されます。影、サイドライン、マスクはすべて新しい形に追従します。端のスタイルはプロジェクトと一緒に保存され、元に戻す/やり直しにも対応します。</li>
        <li><b>拡大表示の画面で適切なサイズに:</b> 表示の拡大縮小を有効にした高解像度の画面では、ボタンや文字が小さく見えていました。アプリは画面の拡大率に従うようになりました。ツールバーのラベルが切れなくなり、ウィンドウが狭いときはツールバーが2行になります。レイヤーパネルは以前より細くドラッグできます。OpenStrand Studio のロゴがすべてのウィンドウとタスクバーに表示されます。</li>
        <li><b>小さな画面に収まるダイアログ:</b> 設定ダイアログを小さくできるようになり、「適用」と「OK」のボタンが常に画面内に収まります。影の編集、グループ影エディター、マスクグリッドの作成、ストランドの角度を編集、幅を変更、動画プレーヤーも同様です。ダイアログは画面より大きく開くことはなく、指定したサイズを保ちます。</li>
        <li><b>より滑らかなドラッグ:</b> 拡大表示の画面やスーパーサンプリングが有効なときでも、ドラッグ中のキャンバスは鮮明なままです。移動モードでは点をドラッグ中に握った手のカーソルが表示されます。表示モードでは左マウスボタンでもパンできるようになりました。更新ボタンのツールチップが実際の動作を示すようになりました: レイヤーを再読み込みして表示をリセット。</li>
        <li><b>ロシア語、フィンランド語、スウェーデン語、日本語、中国語:</b> アプリがロシア語、フィンランド語、スウェーデン語、日本語、中国語で使えるようになりました。設定の「言語を変更」で言語を選んでください。すべてのボタン、メニュー、ダイアログ、ヘルプテキストが翻訳され、各言語には一覧に国旗が表示されます。</li>
    </ul>
    <hr>
    <!-- Chinese -->
    <h2 dir="ltr">欢迎使用 OpenStrandStudio 1.111</h2>
    <p>本程序将在您的计算机上安装 OpenStrandStudio。安装向导将引导您完成必要的步骤。</p>
    <p>版本 1.111 的新功能:</p>
    <ul>
        <li><b>末端样式:</b> 右键点击有自由端的图层，在“闭合绳结”正下方选择“末端样式”。对话框可让你选择绳股的收尾方式: 平直、斜切、圆角、尖角、缺口或凹陷。还可以设置倾斜和深度、延长或修剪末端，并添加带有独立粗细和颜色的侧线。预览会实时显示在画布上。阴影、侧线和遮罩都会跟随新形状。末端样式随项目保存，并支持撤销和重做。</li>
        <li><b>缩放屏幕上的正确尺寸:</b> 在开启了显示缩放的高分辨率屏幕上，按钮和文字以前看起来太小。应用现在会遵循你的显示缩放。工具栏标签不再被截断，窗口较窄时工具栏会换成两行。图层面板可以拖得比以前更窄。OpenStrand Studio 的标志现在显示在每个窗口和任务栏中。</li>
        <li><b>对话框适应小屏幕:</b> 设置对话框现在可以缩小，因此“应用”和“确定”按钮始终留在屏幕上。编辑阴影、组阴影编辑器、创建遮罩网格、编辑绳股角度、更改宽度和视频播放器也是如此。对话框打开时绝不会大于屏幕，并且会保持你设置的大小。</li>
        <li><b>更流畅的拖动:</b> 拖动时画布保持清晰，即使在缩放屏幕上或开启超级采样时也是如此。移动模式下拖动点时会显示握紧的手形光标。查看模式现在也可以用鼠标左键平移。刷新按钮的提示现在说明了它的作用: 重新加载图层并重置视图。</li>
        <li><b>俄语、芬兰语、瑞典语、日语和中文:</b> 应用现已支持俄语、芬兰语、瑞典语、日语和中文。在“设置”的“更改语言”中选择语言: 所有按钮、菜单、对话框和帮助文本都已翻译，每种语言在列表中都有自己的国旗。</li>
    </ul>
</body>
</html>
EOF
...
<body>
    ...
    <p dir="ltr">Что нового в версии 1.111:</p>
    <ul dir="ltr">
        <li><b>Оформление конца:</b> щёлкните правой кнопкой по слою со свободным концом и выберите «Оформить конец» сразу под пунктом «Замкнуть узел». В диалоге можно выбрать, как заканчивается прядь: прямой, скошенный, скруглённый, заострённый, с вырезом или вогнутый конец. Также можно задать наклон и глубину, удлинить или укоротить конец и добавить боковую линию со своей толщиной и цветом. Предпросмотр отображается на холсте сразу. Тень, боковая линия и маски следуют новой форме. Стили концов сохраняются вместе с проектом и работают с отменой и повтором.</li>
        <li><b>Правильный размер на масштабированных экранах:</b> на экранах с высоким разрешением и включённым масштабированием кнопки и текст выглядели слишком мелко. Теперь приложение учитывает масштаб экрана. Надписи на панели инструментов больше не обрезаются, а при узком окне панель переносится на две строки. Панель слоёв можно сузить сильнее, чем раньше. Логотип OpenStrand Studio теперь показывается в каждом окне и на панели задач.</li>
        <li><b>Диалоги помещаются на маленьких экранах:</b> диалог настроек теперь можно уменьшить, поэтому кнопки «Применить» и «ОК» всегда остаются на экране. То же касается редактора теней, редактора теней группы, создания сетки масок, изменения углов прядей, изменения ширины и видеоплеера. Диалог никогда не открывается больше экрана и сохраняет заданный вами размер.</li>
    ...
    <p dir="ltr">Mitä uutta versiossa 1.111:</p>
    <ul dir="ltr">
        <li><b>Muotoile pää:</b> napsauta hiiren oikealla painikkeella tasoa, jolla on vapaa pää, ja valitse Muotoile pää heti Sulje solmu -kohdan alta. Ikkunassa voit valita, miten säie päättyy: suora, viisto, pyöristetty, terävä, lovettu tai kovera. Voit myös asettaa kallistuksen ja syvyyden, pidentää tai lyhentää päätä sekä lisätä sivuviivan, jolla on oma paksuus ja väri. Esikatselu näkyy piirtoalueella heti. Varjo, sivuviiva ja maskit seuraavat uutta muotoa. Pään tyylit tallentuvat projektin mukana ja toimivat kumoamisen ja uudelleentekemisen kanssa.</li>
        <li><b>Oikea koko skaalatuilla näytöillä:</b> korkean resoluution näytöillä, joilla näytön skaalaus on päällä, painikkeet ja teksti näyttivät ennen liian pieniltä. Sovellus noudattaa nyt näytön skaalausta. Työkalupalkin tekstit eivät enää katkea, ja työkalupalkki siirtyy kahdelle riville, kun ikkuna on kapea. Tasopaneelin voi vetää entistä kapeammaksi. OpenStrand Studion logo näkyy nyt jokaisessa ikkunassa ja tehtäväpalkissa.</li>
        <li><b>Ikkunat mahtuvat pienille näytöille:</b> Asetukset-ikkunan voi nyt pienentää, joten sen Käytä- ja OK-painikkeet pysyvät aina näytöllä. Sama koskee varjoeditoria, ryhmän varjoeditoria, maskiruudukon luontia, säikeiden kulmien muokkausta, leveyden muutosta ja videosoitinta. Ikkuna ei koskaan avaudu näyttöä suurempana, ja se säilyttää antamasi koon.</li>
    ...
    <p dir="ltr">Nyheter i version 1.111:</p>
    <ul dir="ltr">
        <li><b>Forma ändsida:</b> högerklicka på ett lager med en fri ände och välj Forma ändsida, strax under Slut knopen. I en dialog väljer du hur strängen slutar: rak, vinklad, rundad, spetsig, skårad eller konkav. Du kan också ställa in lutning och djup, förlänga eller korta änden och lägga till en sidolinje med egen tjocklek och färg. Förhandsvisningen är live på arbetsytan. Skuggan, sidolinjen och maskerna följer alla den nya formen. Ändstilar sparas med projektet och fungerar med ångra och gör om.</li>
        <li><b>Rätt storlek på skalade skärmar:</b> på högupplösta skärmar med skärmskalning påslagen såg knappar och text för små ut. Programmet följer nu din skärmskalning. Verktygsfältets etiketter klipps inte längre av, och verktygsfältet läggs på två rader när fönstret är smalt. Lagerpanelen kan dras smalare än förut. OpenStrand Studio-logotypen visas nu i varje fönster och i aktivitetsfältet.</li>
        <li><b>Dialoger får plats på små skärmar:</b> inställningsdialogen kan nu göras mindre, så att dess Verkställ- och OK-knappar alltid stannar på skärmen. Detsamma gäller Redigera skugga, gruppens skuggredigerare, Skapa maskrutnät, Redigera strängvinklar, Ändra bredd och videospelaren. En dialog öppnas aldrig större än skärmen, och den behåller storleken du ger den.</li>

#!/bin/bash
################################################################################
# OpenStrand Studio - One-command macOS build (v1.108)
#
# Does EVERYTHING in a single run:
#   1. Builds the .app bundle with PyInstaller (OpenStrandStudio_mac.spec)
#   2. Packages the .pkg installer (build_installer_1_108.sh)
#
# Usage:
#   cd src
#   ./build_mac_1_108.sh
#
# Optional:
#   PYTHON=python3.13 ./build_mac_1_108.sh   # choose a specific interpreter
#   ./build_mac_1_108.sh --dmg               # also build the .dmg
#
